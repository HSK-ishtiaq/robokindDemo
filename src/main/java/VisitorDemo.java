        ...
        if (myRobot.isConnected()) {
            ...
            if (danceCommand.equals("Y")) {
                ...
                if (pickDance.equals("1")) {
                    Animation danceAnim1 = Robokind.loadAnimation("AZR50_Dancing_01.anim.xml");
                    myPlayer.playAnimation(danceAnim1);
                    animLen = danceAnim1.getLength();
                    Robokind.sleep(4000 + animLen);
                }
                else if (pickDance.equals("2")) {
                    Animation danceAnim2 = Robokind.loadAnimation("AZR50_Dancing_02.anim.xml");
                    myPlayer.playAnimation(danceAnim2);
                    animLen = danceAnim2.getLength();
                    Robokind.sleep(4000 + animLen);
                }
                else if (pickDance.equals("3")) {
                    Animation danceAnim3 = Robokind.loadAnimation("AZR50_Dancing_03.anim.xml");
                    ...
                    Animation danceAnim4 = Robokind.loadAnimation("AZR50_Dancing_04.anim.xml");
                    ...
                    Animation danceAnim5 = Robokind.loadAnimation("AZR50_Dancing_05.anim.xml");
            ...
            if (extra.equals("Y")) {                
                ...
                Animation victory = Robokind.loadAnimation("AZR50_VictoryPose_02.anim.xml");
            ...
            if (extra.equals("N")) {
                ...
                Animation dissapointed = Robokind.loadAnimation("AZR50_Disappointed_01.anim.xml");
